...
internal class CrystallineConflictPlayerList : PlayerStatsList<CCPlayerJobStats, CrystallineConflictMatch> {
    ...
    protected override List<ColumnParams> Columns { get; set; } = new() {
        ...
        new NumericColumnParams{    Name = Loc.T("Time on Crystal Per Match"),                                                 Id = (uint)"ScoreboardPerMatch.TimeOnCrystal".GetHashCode(),        Width = 100f + Offset,                          Flags = ImGuiTableColumnFlags.DefaultHide | ImGuiTableColumnFlags.WidthFixed },
        ...
        new NumericColumnParams{    Name = Loc.T("Damage Dealt Per Min"),                                                      Id = (uint)"ScoreboardPerMin.DamageDealt".GetHashCode(),            Width = 95f + Offset,                           Flags = ImGuiTableColumnFlags.WidthFixed },
        ...
        new NumericColumnParams{    Name = Loc.T("Time on Crystal Per Min"),                                                   Id = (uint)"ScoreboardPerMin.TimeOnCrystal".GetHashCode(),          Width = 100f + Offset,                          Flags = ImGuiTableColumnFlags.WidthFixed },
        ...
        new NumericColumnParams{    Name = Loc.T("Median Time on Crystal Contrib."),                                           Id = (uint)"ScoreboardContrib.TimeOnCrystal".GetHashCode(),         Width = 110f + Offset,                          Flags = ImGuiTableColumnFlags.DefaultHide | ImGuiTableColumnFlags.WidthFixed },
