...
internal class FrontlinePlayerList : PlayerStatsList<FLPlayerJobStats, FrontlineMatch> {
    ...
    protected override List<ColumnParams> Columns { get; set; } = new() {
        ...
        new NumericColumnParams{    Name = Loc.T("3rd Places"),                                                                Id = (uint)"StatsAll.ThirdPlaces".GetHashCode(),                    Width = 45f + Offset,                           Flags = ImGuiTableColumnFlags.WidthFixed },
        ...
        new NumericColumnParams{    Name = Loc.T("Average Place"),                                                             Id = (uint)"StatsAll.AveragePlace".GetHashCode(),                   Width = 55f + Offset,                           Flags = ImGuiTableColumnFlags.WidthFixed },
        ...
        new NumericColumnParams{    Name = Loc.T("Battle High Per Life"),                                                      Id = (uint)"BattleHighPerLife".GetHashCode(),                       Width = 75f + Offset,                           Flags = ImGuiTableColumnFlags.DefaultHide | ImGuiTableColumnFlags.WidthFixed },
