...
internal class CrystallineConflictRecords : MatchRecords<CrystallineConflictMatch> {
    ...
    protected override Task RefreshInner(List<CrystallineConflictMatch> matches, List<CrystallineConflictMatch> additions, List<CrystallineConflictMatch> removals) {
        ...
        AddSuperlative(mostDamageDealtMatch, Loc.T("Most damage dealt"), mostDamageDealt.ToString());
        ...
        AddSuperlative(mostTimeOnCrystalMatch, Loc.T("Longest time on crystal"), ImGuiHelper.GetTimeSpanString(mostTimeOnCrystal));
        ...
        AddSuperlative(highestDamageDealtPerMinMatch, Loc.T("Most damage dealt per min"), mostDamageDealtPerMin.ToString("0"));
        ...
        AddSuperlative(highestTimeOnCrystalPerMinMatch, Loc.T("Longest time on crystal per min"), ImGuiHelper.GetTimeSpanString(TimeSpan.FromSeconds(mostTimeOnCrystalPerMin)));
